...
from parallel.parallel_funcs import master_workers_queue, print_wise, get_perms, ipca_core
...
if __name__ == "__main__":
    ...
    master_workers_queue(task_list, ipca_core, *(args.model_name, args.num_components, model, loader, device, paths)) 
