...
#SBATCH --job-name=exp_set_alexnet_pS
...
python /leonardo/home/userexternal/tcausin0/exp_set/python_scripts/scripts/leonardo_scripts/alexnet_prob_and_sparseness.py 
